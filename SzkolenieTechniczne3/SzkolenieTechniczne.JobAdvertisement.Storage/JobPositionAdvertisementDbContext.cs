...
namespace SzkolenieTechniczne.JobAdvertisement.Storage
{
    public class JobPositionAdvertisementDbContext : TechnicalTrainingContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder options)
        {
            ...
            options.UseSqlServer(@"server = 127.0.0.1; Database = job-postion-advertisement-dev; user id = sa; password = asdASD123; Encrypt = false; TrustServerCertificate = true; Integrated Security = false;",
